...
func (MotorType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (SensorType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (CtrlType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (IdleMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (InputMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (ParamType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (ParamStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (DefinedFollowerID) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (FollowerSignMode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (ConfigParam) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func init() { proto.RegisterFile("SPARK-MAX-Types.proto", fileDescriptor0) }
